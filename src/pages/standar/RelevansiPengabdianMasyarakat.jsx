...
const RelevansiPengabdianMasyarakat = () => {
  ...
  const dataRelevansiPengabdianMasyarakat = [
    {
      butir: "1.1",
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {dataRelevansiPengabdianMasyarakat.map((item, index) => (
                <tr
                  key={index}
...
export default RelevansiPengabdianMasyarakat;
